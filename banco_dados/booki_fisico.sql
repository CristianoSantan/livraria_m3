...
(default, 'A Arte da Guerra', 'Sun Tzu', 'rocco', 49.9),
(default, 'Originais', 'Adam Grant', 'sextante', 29.9),
(default, 'Harry Potter', 'J. K. Rowling', 'rocco', 49.9),
(default, 'Sherlock Holmes', 'Arthur Conan Doyle', 'atlas', 35.9);

insert into Compras values 
(default, '18/09/2023',  2, 1, 35.9),
(default, '16/09/2023',  1, 2, 49.9);

-- consulta(read) dos dados
select * from Livros;
select * from Usuarios;
select * from Compras;
select c.id_compra, c.data_compra, l.*, u.* 
...
UPDATE Livros SET nome_livro = 'Harry Potter e a Pedra Filosofal', autor_livro = 'J. K. Rowling', editora_livro = 'rocco', preco_livro = 49.9 WHERE id_livro = 1;
